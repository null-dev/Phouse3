...
public class Matrix {
    ...
    public static void multiplyMM(float[] output, int outputOffset, float[] lhs, int lhsOffset, float[] rhs,
        ...
        //	}
        //}
        output[outputOffset] = lhs[lhsOffset] * rhs[rhsOffset] + lhs[lhsOffset + 4] * rhs[rhsOffset + 1]
                + lhs[lhsOffset + 8] * rhs[rhsOffset + 2] + lhs[lhsOffset + 12] * rhs[rhsOffset + 3];
        output[outputOffset + 1] = lhs[lhsOffset + 1] * rhs[rhsOffset] + lhs[lhsOffset + 5] * rhs[rhsOffset + 1]
                + lhs[lhsOffset + 9] * rhs[rhsOffset + 2] + lhs[lhsOffset + 13] * rhs[rhsOffset + 3];
        output[outputOffset + 2] = lhs[lhsOffset + 2] * rhs[rhsOffset] + lhs[lhsOffset + 6] * rhs[rhsOffset + 1]
                + lhs[lhsOffset + 10] * rhs[rhsOffset + 2] + lhs[lhsOffset + 14] * rhs[rhsOffset + 3];
        output[outputOffset + 3] = lhs[lhsOffset + 3] * rhs[rhsOffset] + lhs[lhsOffset + 7] * rhs[rhsOffset + 1]
                + lhs[lhsOffset + 11] * rhs[rhsOffset + 2] + lhs[lhsOffset + 15] * rhs[rhsOffset + 3];

        output[outputOffset + 4] = lhs[lhsOffset] * rhs[rhsOffset + 4] + lhs[lhsOffset + 4] * rhs[rhsOffset + 5]
        ...
        output[outputOffset + 8] = lhs[lhsOffset] * rhs[rhsOffset + 8] + lhs[lhsOffset + 4] * rhs[rhsOffset + 9]
        ...
        output[outputOffset + 12] = lhs[lhsOffset] * rhs[rhsOffset + 12] + lhs[lhsOffset + 4] * rhs[rhsOffset + 13]
     ...
     * 
     * @param output (resultVec) The float array that holds the result vector.
     * @param outputOffset (resultVecOffset) The offset into the result array where the result
     *            vector is stored.
     * @param lhs (lhsMat) The float array that holds the left-hand-side matrix.
     * @param lhsOffset (lhsMatOffset) The offset into the lhs array where the lhs is stored
     * @param rhs (rhsVec) The float array that holds the right-hand-side vector.
     * @param rhsOffset (rhsVecOffset) The offset into the rhs vector where the rhs vector
     *            is stored.
     * 
