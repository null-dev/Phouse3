...
public class Quaternion extends Vector4f {
    ...
    public boolean equals(Object o) {
        ...
        return dirty == that.dirty
                && !(matrix != null ? !matrix.equals(that.matrix) : that.matrix != null)
                && !(bufferQuaternion != null ? !bufferQuaternion.equals(that.bufferQuaternion) : that.bufferQuaternion != null);
    ...
    public int hashCode() {
        ...
        result = 31 * result + (bufferQuaternion != null ? bufferQuaternion.hashCode() : 0);
        return result;
    }
}
