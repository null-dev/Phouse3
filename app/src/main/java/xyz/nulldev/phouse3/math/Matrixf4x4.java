...
public class Matrixf4x4 {
    ...
    public void setMatrixValues(float[] otherMatrix) {
        ...
        System.arraycopy(otherMatrix, 0, this.matrix, 0, otherMatrix.length);
    }
    ...
    public boolean equals(Object o) {
        ...
        Matrixf4x4 that = (Matrixf4x4) o;

        return colMaj == that.colMaj
                && matrixValid == that.matrixValid
    ...
    @Override
    public int hashCode() {
        int result = (colMaj ? 1 : 0);
        result = 31 * result + (matrixValid ? 1 : 0);
        result = 31 * result + (matrix != null ? Arrays.hashCode(matrix) : 0);
        return result;
    }
}
